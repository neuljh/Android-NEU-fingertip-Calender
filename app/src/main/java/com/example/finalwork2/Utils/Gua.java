...
public class Gua extends View{
    ...
    public Gua(Context context, AttributeSet attrs) {
        ...
        //中间圆的背景颜色  默认为浅紫色
        mCircleBackground = typedArray.getColor(R.styleable.PercentageRing_circleBackground, 0x807adfb8);
        //外圆环的颜色  默认为深紫色
        mRingColor = typedArray.getColor(R.styleable.PercentageRing_ringColor, 0xffffffff);
        //中间圆的半径 默认为60
        mRadius = 3*typedArray.getInt(R.styleable.PercentageRing_radius, 200);
        //字体颜色 默认为白色
