...
//        );
     ...
     * getAllData()
     */
    public void add(String name, String password,String email,String phonenum,String username,String school,String sex){
        db.execSQL("INSERT INTO user (name,password,email,phonenum,username,school,sex) VALUES(?,?,?,?,?,?,?)",new Object[]{name,password,email,phonenum,username,school,sex});
    }
    public void delete(String name,String password){
        db.execSQL("DELETE FROM user WHERE name = AND password ="+name+password);
    }
    public void updata(String name, String password,String email,String phonenum,String username,String school,String sex){
        db.execSQL("UPDATE user SET name = ?",new Object[]{name});
        db.execSQL("UPDATE user SET password = ?",new Object[]{password});
        db.execSQL("UPDATE user SET email = ?",new Object[]{email});
        db.execSQL("UPDATE user SET phonenum = ?",new Object[]{phonenum});
    ...
    public ArrayList<User> getAllData(){
        ...
        while(cursor.moveToNext()){
            ...
            list.add(new User(name,password,email,phonenum,username,school,sex));
            //User(String name, String password, String email, String phonenumber, String username, String school, String sex)
        }
        return list;
    }
}
