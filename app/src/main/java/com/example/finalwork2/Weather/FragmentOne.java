package com.example.finalwork2.Weather;
...
//        nowDate= ContentUtils.From_Date_Get_Year(nowDateTime.getNowDate())+"年"+Integer.parseInt(ContentUtils.From_Date_Get_Month(nowDateTime.getNowDate()))+"月"+nowDate;
//        tvNowDate.setText("今天 "+ nowDate);
        tvNowDate.setText("今天 "+nowDateTime.getNowDate()+ ContentUtils.CaculateWeekday(Integer.parseInt(ContentUtils.From_Date_Get_Year(nowDateTime.getNowDate())),Integer.parseInt(ContentUtils.From_Date_Get_Month(nowDateTime.getNowDate())),Integer.parseInt(ContentUtils.From_Date_Get_Day(nowDateTime.getNowDate()))));
