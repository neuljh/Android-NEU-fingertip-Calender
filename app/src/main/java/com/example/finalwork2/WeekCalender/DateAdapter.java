package com.example.finalwork2.WeekCalender;
...
public class DateAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tv.setTextColor(ContextCompat.getColor(context,R.color.white_bg));
        holder.tv_month.setTextColor(ContextCompat.getColor(context,R.color.white_bg));

        if (clickTemp == position) {
            holder.ll_data.setSelected(true);
            holder.ll_data.setBackgroundResource(R.drawable.corners_bg);
//            holder.view_line.setVisibility(View.VISIBLE);
        } else {
            holder.ll_data.setSelected(false);
//            holder.ll_data.setBackgroundResource(R.color.white);
            holder.ll_data.setBackgroundResource(R.drawable.corners_bg_touming);
